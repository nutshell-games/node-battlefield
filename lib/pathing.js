...
var Path = (function () {
    function Path(endpointA, endpointB, segments, bezier) {
        ...
        this.bezier = bezier;
        this.checkpoints.push(new checkpoint_1.Checkpoint(endpointA));
        this.checkpoints.push(new checkpoint_1.Checkpoint(endpointB));
    ...
    Path.prototype.removeUnit = function (unit) {
        this.units = _.without(this.units, unit);
    };
    Path.prototype.addUnit = function (unit) {
        if (!_.includes(this.units, unit)) {
            this.units.push(unit);
        }
    };
    Path.prototype.addCheckpoint = function (checkpoint) {
    };
    return Path;
})();
module.exports = Path;
